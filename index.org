...
5 - Newer version of Orgmode stick clocks into logbooks which aren't useful for me
6 - Make collapsing and expanding sections with the TAB button work everywhere (except where it makes sense to insert an actual /tab/)
7 - ~htmlize~ will colorize orgmode code-blocks code in the exported HTML
